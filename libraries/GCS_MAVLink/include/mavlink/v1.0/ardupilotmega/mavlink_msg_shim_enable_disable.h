...
#define MAVLINK_MSG_ID_SHIM_ENABLE_DISABLE_LEN 1
#define MAVLINK_MSG_ID_230_LEN 1

#define MAVLINK_MSG_ID_SHIM_ENABLE_DISABLE_CRC 6
#define MAVLINK_MSG_ID_230_CRC 6
...
#define MAVLINK_MESSAGE_INFO_SHIM_ENABLE_DISABLE { \
	"SHIM_ENABLE_DISABLE", \
	1, \
	{  { "enable", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_shim_enable_disable_t, enable) }, \
         } \
}
...
static inline void mavlink_msg_shim_enable_disable_send(mavlink_channel_t chan, uint8_t enable)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_SHIM_ENABLE_DISABLE_LEN];
	_mav_put_uint8_t(buf, 0, enable);
 ...
 */
static inline void mavlink_msg_shim_enable_disable_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t enable)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline uint8_t mavlink_msg_shim_enable_disable_get_enable(const mavlink_message_t* msg)
{
