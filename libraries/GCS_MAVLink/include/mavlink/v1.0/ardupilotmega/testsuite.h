...
static void mavlink_test_shim_stats(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_msg_shim_stats_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_shim_stats_pack(system_id, component_id, &msg , packet1.time , packet1.percent_rejected_ver , packet1.percent_rejected_unver , packet1.avg_accel_diff_ver , packet1.avg_accel_diff_unver );
	mavlink_msg_shim_stats_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_shim_stats_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time , packet1.percent_rejected_ver , packet1.percent_rejected_unver , packet1.avg_accel_diff_ver , packet1.avg_accel_diff_unver );
	mavlink_msg_shim_stats_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_shim_stats_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_shim_stats_send(MAVLINK_COMM_1 , packet1.time , packet1.percent_rejected_ver , packet1.percent_rejected_unver , packet1.avg_accel_diff_ver , packet1.avg_accel_diff_unver );
	mavlink_msg_shim_stats_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
